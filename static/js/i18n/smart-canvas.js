(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.megabyParamsReset": { zh: "MegabyAI 仅支持 4–15 秒、16:9 / 9:16 / 1:1 和 Auto / 480p / 720p，已重置为 5 秒、16:9、720p。", en: "MegabyAI supports only 4–15 seconds, 16:9 / 9:16 / 1:1, and Auto / 480p / 720p. Parameters were reset to 5 seconds, 16:9, and 720p." },
        "smart.sudashuiOfficialCleared": { zh: "参考图顺序或视频协议已变化，请重新填写真人素材编号", en: "Reference image order or video protocol changed; re-enter human asset numbers" },
        "smart.videoResolutionModelValue": { zh: "模型自动：{resolution}", en: "Model-defined: {resolution}" },
        "smart.videoResolutionModelAuto": { zh: "模型自动", en: "Model-defined" },
        "smart.videoResolutionModelTip": { zh: "分辨率由模型决定，请求不会额外发送 resolution", en: "Resolution is defined by the model; resolution is not sent separately" },
        "smart.sudashuiOfficialAssetNumbers": { zh: "真人素材图片编号", en: "Human asset image numbers" },
        "smart.sudashuiOfficialAssetPlaceholder": { zh: "例如 1,3", en: "For example 1,3" },
        "smart.sudashuiOfficialAssetTip": { zh: "按图1、图2顺序填写；空值表示没有真人或虚拟人", en: "Use image order (Image 1, Image 2); leave empty when no human or virtual-person asset is used" },
        "smart.imageNumber": { zh: "图{number}", en: "Image {number}" },
        "smart.sudashuiOfficialAssetError": { zh: "真人素材图片编号不合法", en: "Invalid human asset image numbers" },
        "smart.videoImageRequired": { zh: "当前模型至少需要 {count} 张参考图片", en: "This model requires at least {count} reference image(s)" },
        "smart.videoReferenceUnsupported": { zh: "当前模型不支持参考{kind}", en: "This model does not support {kind} references" },
        "smart.videoReferenceLimit": { zh: "当前模型最多支持 {count} 个{kind}素材", en: "This model supports at most {count} {kind} reference(s)" },
        "smart.sudashuiAutoUploadTip": { zh: "本地素材提交时自动上传 Sudashui；公网 URL 直接传递", en: "Local media is uploaded to Sudashui on submit; public URLs are passed through" },
        "smart.sudashuiDurationError": { zh: "Sudashui 视频时长必须为 4 到 15 秒", en: "Sudashui video duration must be between 4 and 15 seconds" },
        "smart.sudashuiAspectError": { zh: "Sudashui 不支持当前画面比例", en: "The selected aspect ratio is not supported by Sudashui" },
        "smart.sudashuiImageLimit": { zh: "Sudashui 最多支持 {count} 张参考图", en: "Sudashui supports up to {count} reference images" },
        "smart.sudashuiVideoLimit": { zh: "Sudashui 最多支持 {count} 个参考视频", en: "Sudashui supports up to {count} reference videos" },
        "smart.sudashuiAudioLimit": { zh: "Sudashui 最多支持 {count} 个参考音频", en: "Sudashui supports up to {count} reference audio files" },
        "smart.sudashuiTotalLimit": { zh: "Sudashui 参考素材总数不能超过 {count}", en: "Sudashui allows at most {count} reference assets in total" },
        "smart.sudashuiFramesError": { zh: "Sudashui 首尾帧模式必须恰好包含两张图片，且不能包含视频或音频", en: "Sudashui frame mode requires exactly two images and no video or audio references" },
        "smart.sudashuiOfficialVideoError": { zh: "Sudashui 官方模型不支持参考视频", en: "Sudashui official models do not support video references" },
        ...
        "smart.videoNoMediaReturned": { zh: "任务已完成但未返回可用媒体地址，任务已保留，可稍后点击“查询结果”重试", en: "Task completed but returned no usable media URL; the task is kept — click \"Query result\" later to retry" },
        "smart.videoTaskFailedTitle": { zh: "视频任务失败", en: "Video task failed" },
        "smart.videoTaskFailedDismiss": { zh: "关闭", en: "Dismiss" },
        "smart.taskPreservedQueryLater": { zh: "任务未丢失，可稍后手动查询结果", en: "The task is not lost; you can query the result manually later" },
        "smart.noTaskIdForQuery": { zh: "没有任务 ID，无法查询", en: "No task ID available; cannot query" },
        "smart.videoTaskStillRunning": { zh: "视频任务仍在生成中", en: "The video task is still running" },
        "smart.taskStillRunningRetryLater": { zh: "任务仍在生成中，请稍后再查询", en: "The task is still running; please query again later" },
        "smart.queryFailed": { zh: "查询失败", en: "Query failed" },
        "smart.trustedAssetMismatch": { zh: "部分认证素材属于其它平台，已回退为普通素材。切换到对应平台的视频接口才能用 asset:// 认证地址。", en: "Some trusted assets belong to another platform and were downgraded to plain media. Switch to that platform's video API to use asset:// trusted URIs." },
